						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card m-b-30">
									<div class="card-body">
										<f:form class="" action="saveCity" method="post" modelAttribute="manageCityVO">
											
											<div class="form-group">
												<label>City Name</label>
												<f:hidden path="id"/>
												 <!-- <input type="text"
													class="form-control" required placeholder="Type City Name"> -->
													
													<f:input path="cityName" class="form-control" placeholder="Type City Name" required="required"/>
											</div>
											...
											<div class="form-group">
												...
												<div>
 													...
 													<f:textarea path="cityDescription" required="required" rows="5" class="form-control"/>
												</div>
											</div>
