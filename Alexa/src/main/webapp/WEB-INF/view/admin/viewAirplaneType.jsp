									...
									<div class="btn-group float-right">
										<ol class="breadcrumb hide-phone p-0 m-0">
											...
											<li class="breadcrumb-item"><a href="#">Manage
													AirplaneType</a></li>
											<li class="breadcrumb-item active">View AirplaneType</li>
										</ol>
									</div>
									<h4 class="page-title">View AirplaneType</h4>
								</div>
							</div>
						</div>
								...
								<div class="card m-b-30">
									<div class="card-body">
										<table id="datatable-buttons"
											...
											<tbody>
												<c:forEach items="${airplaneTypeList}" var="i" varStatus="j">
													<tr>
														<td>${j.count}</td>
														...
														<td>${i.firstClass}</td>
														<td>${i.total}</td>
														<td><a href="editAirplaneType?id=${i.id}"> <i
