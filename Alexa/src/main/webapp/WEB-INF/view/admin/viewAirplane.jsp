...
<link href="<%=request.getContextPath()%>\adminResources\css\photoStyle.css"
	rel="stylesheet" type="text/css">
...
<body class="fixed-left">
									...
									<div class="btn-group float-right">
										<ol class="breadcrumb hide-phone p-0 m-0">
											...
											<li class="breadcrumb-item"><a href="#">Manage
													Airplane</a></li>
											<li class="breadcrumb-item active">View Airplane</li>
										</ol>
									</div>
										...
										<table id="datatable-buttons"
											...
											<thead>
												<tr>
													...
													<!-- <th>Capacity</th>
													<th>First-Class </th>
													<th>Executive-Class </th>
													<th>Economy-Class </th> -->
													<th>Airplane Number</th>
													<th>Airplane Description</th>
													<th>Airplane Picture</th>
													<th>Action</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach items="${airplaneList}" var="i" varStatus="j">
													<tr>
														<td>${j.count}</td>
													...
													<td>${i.economyClass}</td> --%>
														...
														<%-- <td><a
															href="<%=request.getContextPath()%>/document/airplane/${i.airplaneFileName}"
															target="_blank"> <img
																src="<%=request.getContextPath()%>/document/airplane/${i.airplaneFileName}"
																target="_blank" alt="/${i.airplaneFileName}"
																class="img-fluid" style="user-select: auto; width: 80%;"></a></td> --%>
														...
														<td><a href="editAirplane?id=${i.id}"> <i
																class="mdi mdi-pencil font-20"></i>
														</a> <a href="deleteAirplane?id=${i.id}"> <i
	...
	<script src="<%=request.getContextPath()%>\adminResources\js\custom\photoSet.js"></script>
