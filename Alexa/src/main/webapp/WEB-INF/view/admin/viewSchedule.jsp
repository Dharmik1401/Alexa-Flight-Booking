										...
										<table id="datatable-buttons"
											...
											<thead>
												<tr>
													...
													<th>Return From Airport - To Airport</th>
													<th>Days</th>
													<th>Pricing</th>
													<th>Action</th>
												</tr>
											...
											<tbody>
												<c:forEach items="${scheduleList}" var="i" varStatus="j">
													<tr>
														<td>${j.count}</td>
														<td>${i.routeName}</td>
														<td>${i.manageAirplaneVO.airplaneNumber}</td>
														<td>${i.routeType}</td>
														...
														<td>${i.manageFromAirportVO.airportName}-
															${i.arrivalTime} ${i.manageToAirportVO.airportName}-
															${i.departureTime}</td>
														<td>${i.manageReturnFromAirportVO.airportName}-
															${i.returnArrivalTime} 
															  ${i.manageReturnToAirportVO.airportName}
															${i.returnDepartureTime}</td>
